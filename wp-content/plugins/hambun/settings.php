...
$spp_settings->url_rewrites = array( 
    'read' => array('separator' => '-', 'rule' => 'ssi/(.*)', 'index' => 1, 'permalink' => 'ssi/{{ term }}' ), //0
    ...
    'single_image' => array('separator' => '-', 'rule' => 'journal/(.*)', 'index' => 1, 'permalink' => 'journal/{{ term }}' ), //3    
